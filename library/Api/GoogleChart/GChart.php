...
class Api_GoogleChart_GChart {
	...
	protected function encodeData($data, $separator, $encodigData = '') {
        ...
        $retStr = $this->separateData($data, $separator, $datasetSeparator);
        $retStr = trim($retStr, $datasetSeparator);
...
class gPieChart extends Api_GoogleChart_GChart {
...
class gLineChart extends Api_GoogleChart_GChart {
...
class gBarChart extends Api_GoogleChart_GChart {
	/**
...
class gVennDiagram extends Api_GoogleChart_GChart {
...
class gFormula extends Api_GoogleChart_GChart {
	/**
...
class gQRCode extends Api_GoogleChart_GChart {
...
class gMeterChart extends Api_GoogleChart_GChart {
	/**
...
class gMapChart extends Api_GoogleChart_GChart {
	/**
...
class gScatterChart extends Api_GoogleChart_GChart{
	function __construct($width = 200, $height = 200){
		$this -> setDimensions($width, $height);
